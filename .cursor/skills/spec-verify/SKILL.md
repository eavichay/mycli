---
name: spec-verify
description: "Verify feature completeness against specification \u2014 test gate,\
  \ diff analysis, and 4-pillar compliance assessment."
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: preset:agentic-sdlc
---

# Speckit Spec Verify Skill
...
Run `.specify/scripts/bash/check-prerequisites.sh --json --include-tasks` once from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS. Abort with a clear error if the feature directory doesn't exist or is missing required artifacts (spec.md, plan.md, tasks.md).
